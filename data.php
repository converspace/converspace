<?php
	...
	function db_get_posts($direction, $from_post_id)
	{
		if ('before' == $direction)
		{
	...
	function db_get_channel_posts($channel_name, $direction, $from_post_id)
	{
		if ('before' == $direction)
		{
